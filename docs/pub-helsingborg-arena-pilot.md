# Personuppgiftsbiträdesavtal (PUB) — pilot CVmatchen

**Helsingborgs stad, Arbetsmarknadsförvaltningen** (org.nr 212000-1157),
enheten Ungdoms-/Kompetensarena — nedan **Personuppgiftsansvarig (PUA)**
...
> **Två parter — två underskrifter.** Detta avtal tecknas mellan kommunen
> och PathfinderAI. För kommunen undertecknar en behörig företrädare
> (t.ex. verksamhets-/enhetschef) — **inte** Oliver Pettersson i sin roll
> som anställd SYV. Oliver undertecknar enbart för PathfinderAI. Beslutet
> att genomföra piloten fattas och diarieförs av kommunen oberoende av
> Oliver (jävshantering enligt förvaltningslagen; bisysslan är prövad och
> godkänd av HR genom undertecknat beslut).
...
Ungdoms-/Kompetensarena. Piloten omfattar cirka **20–40 deltagare** och
**3–4 handläggare**. Syftet är att pröva verktyget i skarp verksamhet och
...
domstol, Helsingborgs tingsrätt som första instans.

---

## Underskrifter

**För Helsingborgs stad, Arbetsmarknadsförvaltningen (Personuppgiftsansvarig):**
...
- **Ändamål:** CV-skapande, jobbmatchning, intervjuträning och uppföljning
  inom kommunens arbetsmarknadsverksamhet (Ungdoms-/Kompetensarena).
- **Varaktighet:** pilot 3 månader från driftsättning.
- **Registrerade:** ca 20–40 deltagare + 3–4 handläggare.
