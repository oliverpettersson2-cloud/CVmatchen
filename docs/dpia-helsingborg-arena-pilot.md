...
## 1. Omfattning
Tidsbegränsad pilot (3 mån) inom Ungdoms-/Kompetensarena: ca 20–40 deltagare
och 3–4 handläggare. CV-skapande, jobbmatchning, intervjuträning, uppföljning.
...
| Jäv (leverantör = anställd) | Medel | HR-godkänd bisyssla + kommunen äger pilotbeslut + Oliver utanför köp/utvärdering | Låg |
